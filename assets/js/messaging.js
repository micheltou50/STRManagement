...
export function renderChatBubble() {
  ...
  container.innerHTML = `
    <div id="chat-fab" onclick="window._stayOpsOpenChat()" style="position:fixed;bottom:80px;right:16px;z-index:999;cursor:pointer">
      <div style="width:54px;height:54px;border-radius:50%;background:#1E3A2F;box-shadow:0 4px 14px rgba(30,58,47,0.4);display:flex;align-items:center;justify-content:center">
    ...
    <div id="chat-preview" style="display:none;position:fixed;bottom:142px;right:16px;z-index:999;background:#fff;padding:10px 14px;border-radius:14px 14px 4px 14px;box-shadow:0 4px 16px rgba(0,0,0,0.12);max-width:220px;cursor:pointer" onclick="window._stayOpsOpenChat()">
