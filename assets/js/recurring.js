  ...
  for (const t of filtered) {
    ...
    html += '<div style="padding:14px 16px;border-bottom:1px solid #F0ECE6;display:flex;align-items:center;justify-content:space-between;' + enabledClass + '" data-rec-id="' + t.id + '">' +
      '<div style="flex:1;min-width:0">' +
        '<div style="font-weight:500;font-size:14px;color:var(--ink-1);font-family:\'Plus Jakarta Sans\',sans-serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis">' + _escHtml(t.merchant) + '</div>' +
        ...
        '</div>' +
        '<div style="font-size:11px;color:var(--muted-2);font-family:\'Plus Jakarta Sans\',sans-serif;margin-top:1px">' + _escHtml(t.category || '') + '</div>' +
      '</div>' +
